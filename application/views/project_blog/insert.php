                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel">Tambah Kategori Blog</h4>
                                        </div>
                                        ...
                                        // Form
                                        echo form_open('kategori_blog');
                                        ?>
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label>Nama kategori</label>
                                                    <input type="text" name="nama_kategori_blog" placeholder="Nama kategori blog" value="<?php echo set_value('nama_kategori_blog') ?>" required class="form-control">
                                            </div>
                                        </div>
