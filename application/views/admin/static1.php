  ...
  =========================================================-->
    <header>  
      ...
      <!--<div class="border1">
        ...
        <div class="dropdown">
          <button class="btn btn-dropdown-baru-static1 dropdown-toggle" type="button" data-toggle="dropdown">Menu
          <span class="caret"></span></button>
          <ul class="dropdown-menu">
            <li><a href="<?php echo base_url();?>index.php/admin/dashboard">Dashboard</a></li>
            <li class="divider"><a href="<?php echo base_url('index.php/logout')?>">Sign Out</a></li>
          </ul>
        </div>  
        ...
        <nav class="navbar navbar-default navbar-static-top pull-left">            
            ...
            <div class="">  
              <ul class="nav navbar-nav sf-menu" data-type="navbar">
                ...
                <li>
                  <a href="<?php echo base_url();?>index.php/about/frontend_about">ABOUT</a>
                </li>
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li>
                      <a href="<?php echo base_url();?>storage2">Shared Files</a>
                    </li>
                    <li>
                ...
                <li class="dropdown">
                  <a href="<?php echo base_url();?>index.php/admin/service">ACCOUNT<span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span></a>
                  <ul class="dropdown-menu">
                    <li>
                      <a href="<?php echo base_url();?>index.php/admin/dashboard">DASHBOARD</a>
                    </li>
